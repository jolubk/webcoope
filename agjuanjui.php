        ...
        <div class="contenedor">            
            <div class="menu-detalle">
                ...
                <div class="lista-enlace" id="nosotros" style="display:block; padding-top:0;">
                    ...
                    <a href="agjuanjui.php">Agencia Juanjuí <i class="fas fa-chevron-right menu-lat-enlace-flecha" style="float:right;"></i></a>
                </div>
            </div>
            <div class="descripcion">
                <div class="division">
                    <div class="detag">
                        <h3>AGENCIA JUANJUÍ</h3>
                        <div class="fotoag">
                    ...
                    <div class="mapa">
                        <img src="img/ag/juanjui.png" alt="Mapa de Cobertura">
                    </div>                    
                </div>
            </div>
        </div>
