        ...
        <div class="contenedor">            
            <div class="menu-detalle">
                ...
                <div class="lista-enlace" id="nosotros" style="display:block; padding-top:0;">
                    ...
                    <a href="agbambamarca.php">Agencia Nuevo Bambamarca <i class="fas fa-chevron-right menu-lat-enlace-flecha" style="float:right;"></i></a>
            ...
            <div class="descripcion">
                <div class="division">
                    <div class="detag">
                        <h3>AGENCIA NUEVO BAMBAMARCA</h3>
                        <div class="fotoag">
                    ...
                    <div class="mapa">
                        <img src="img/ag/nvobambamarca.png" alt="Mapa de Cobertura">
                    </div>                    
                </div>
            </div>
        </div>
