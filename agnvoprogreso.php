        ...
        <div class="contenedor">            
            <div class="menu-detalle">
                ...
                <div class="lista-enlace" id="nosotros" style="display:block; padding-top:0;">
                    ...
                    <a href="agnvoprogreso.php">Agencia Nuevo Progreso <i class="fas fa-chevron-right menu-lat-enlace-flecha" style="float:right;"></i></a>
            ...
            <div class="descripcion">
                <div class="division">
                    <div class="detag">
                        <h3>AGENCIA NUEVO PROGRESO</h3>
                        <div class="fotoag">
                            <div class="foto"><img src="img/ag/agnvoprogreso.png" alt="Agencia Nuevo Progreso"></div>
                            <div class="detfoto">
                                <br><br><span><i class="fas fa-map-marker-alt"></i> Jr. Huallaga 557 - Nuevo Progreso</span>
                                <br><br><span><i class="fas fa-phone-alt"></i> 042-551533 / Anexo 600</span>
                                <br><br><span><i class="fas fa-mobile-alt"></i> 942165331 </span>
                            </div>
                        </div>
                    ...
                    <div class="mapa">
                        <img src="img/ag/nvoprogreso.png" alt="Mapa de Cobertura">
                    </div>                    
                </div>
            </div>
        </div>
