<div class="tab-vertical" id="menu-vertical">
    <div class="nav">
        <a class="active menu-lat-enlace" id="menu-comercial">
...
<div class="tab-vertical" id="menu-servicios">
    <div class="tipo-ahorros">
        <div class="enlace-ahorros"><a href="prevsocial.php"><div>PREVISIÓN SOCIAL</div></a></div>
        <div class="enlace-ahorros"><a href="beneficios.php"><div>BENEFICIOS POR SER SOCIO</div></a></div>
        <div class="enlace-ahorros"><a href="intercoopac.php"><div>OPERACIONES INTERCOOPERATIVAS</div></a></div>
        <div class="enlace-ahorros"><a href="pagos.php"><div>PAGOS, SERVICIOS Y OTROS</div></a></div>
    </div>
</div>